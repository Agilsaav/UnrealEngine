...
#include "CoopGame/Challenges/SExplosiveBarrel.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ASExplosiveBarrel_OnHealthChanged_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Challenges/SExplosiveBarrel.h" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ASExplosiveBarrel_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ASExplosiveBarrel_OnHealthChanged, "OnHealthChanged" }, // 1382485141
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ASExplosiveBarrel, 1473897761);
