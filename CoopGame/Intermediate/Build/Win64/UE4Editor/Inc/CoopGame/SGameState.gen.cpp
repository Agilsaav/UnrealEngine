...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_CoopGame_EWaveState_Hash() { return 519206912U; }
	UEnum* Z_Construct_UEnum_CoopGame_EWaveState()
	{
		...
		if (!ReturnEnum)
		{
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "WaveComplete.ToolTip", "No longer spawning new bots, waiting for players to kill remaining bots" },
			};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ASGameState_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ASGameState_OnRep_WaveState, "OnRep_WaveState" }, // 3450717053
		{ &Z_Construct_UFunction_ASGameState_WaveStateChanged, "WaveStateChanged" }, // 1943126179
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ASGameState, 179397539);
